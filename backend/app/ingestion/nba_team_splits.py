...
SELECT
    ...
    g.home_rebounds, g.home_offensive_rebounds, g.home_assists, g.home_steals, g.home_blocks,
    ...
    g.away_rebounds, g.away_offensive_rebounds, g.away_assists, g.away_steals, g.away_blocks,
