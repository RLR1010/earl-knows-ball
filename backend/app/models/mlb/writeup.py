...
class MLBGameWriteup(Base):
    ...
    game_id = Column(
        Integer,
        ForeignKey("mlb.games.id", ondelete="CASCADE"),
        nullable=False,
        unique=True,
        index=True,
    )
    ...
    # Relationships
    game = relationship("MLBGames", backref="writeups")

    def __repr__(self) -> str:
        return (
            f"<MLBGameWriteup id={self.id} game_id={self.game_id} "
