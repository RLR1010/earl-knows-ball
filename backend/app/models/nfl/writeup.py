...
class NFLGameWriteup(Base):
    ...
    game_id = Column(
        Integer,
        ForeignKey("nfl.games.id", ondelete="CASCADE"),
        nullable=False,
        unique=True,
        index=True,
    )
    ...
    # Relationships
    game = relationship("Game", backref="writeups")

    def __repr__(self) -> str:
        return (
            f"<NFLGameWriteup id={self.id} game_id={self.game_id} "
