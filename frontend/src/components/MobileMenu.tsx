                ...
                {loading ? (
                  ...
                  <>
                    ...
                    <Link
                      href="/support"
                      onClick={() => setMenuOpen(false)}
                      className={linkClass(pathname === "/support")}
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                        <path strokeLinecap="round" strokeLinejoin="round" d="M8 10h.01M12 10h.01M16 10h.01M21 12c0 4.418-4.03 8-9 8a9.86 9.86 0 01-4-.86L4 21l1.2-3.3A7.9 7.9 0 013 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                      </svg>
                      Support
                    </Link>
                    <button
